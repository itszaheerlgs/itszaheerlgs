...
|---|---|---|
| [**HIMS File Manager**](https://github.com/itszaheerlgs/HIMS-File-Manager-Enterprise) | OPD Document Management System — a Windows desktop app for securely storing, organizing, and tracking scanned patient/OPD records, with role-based access, an audit trail, and a date-based calendar view for uploads. | C#NET |
